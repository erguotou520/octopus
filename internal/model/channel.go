...
// Custom channel types (HEAD additions not in upstream axonhub/llm)
const ChannelTypeGithubCopilot llm.APIFormat = "github/copilot"
const ChannelTypeAntigravity   llm.APIFormat = "antigravity"
const ChannelTypeZen           llm.APIFormat = "zen"
